    ...
    <body>
      <div class="container">
        ...
        <div class="contact-info">
          ...
          <p style="margin: 0;"><strong>24/7 Emergency Line:</strong> <a href="tel:+61-XXX-XXX-XXX" style="color: #DC2626;">+61 XXX XXX XXX</a></p>
          <p style="margin: 10px 0 0 0;"><strong>Email:</strong> <a href="mailto:contact@everguardintelligence.com" style="color: #DC2626;">contact@everguardintelligence.com</a></p>
        </div>

        <div style="background: #fef2f2; padding: 15px; border-radius: 8px; border: 1px solid #fecaca; margin: 20px 0;">
          <p style="margin: 0; color: #991b1b;"><strong>🔒 Confidentiality Assured:</strong> All communications are treated with the strictest confidentiality in accordance with our ANZIIF compliance standards.</p>
        </div>
